    ...
    <div className="grid grid-cols-3 gap-3">
      {keys.map((k, idx) => (
        <div key={k.key} className="bg-[#0f172a] p-3 rounded-xl border border-slate-800 focus-within:border-slate-600 transition-colors">
          <span className={`block text-[9px] ${colors[idx] || 'text-slate-500'} font-bold mb-1 uppercase`}>
            {k.label}
          </span>
          <input 
            name={k.key} 
        ...
        <div className="col-span-4 flex flex-col gap-8 h-full">
           ...
           <div className="relative group flex-shrink-0">
              <textarea 
                ...
                className={`w-full bg-[#1e293b] border-2 rounded-2xl p-6 text-xs font-mono transition-all duration-300 outline-none resize-none h-16 overflow-hidden shadow-lg ${
                   ...
                   {results && (
                     <>
                       <div className="flex flex-col items-end">
                         <span className="text-[9px] font-black text-slate-500 uppercase tracking-widest">Bookie Margin</span>
                         <span className="text-lg font-mono font-bold text-rose-400">{results.margin}%</span>
                       </div>
                       <div className="flex flex-col items-end">
                         <span className="text-[9px] font-black text-slate-500 uppercase tracking-widest">Fit Precision</span>
                         <div className="flex items-center gap-2">
                ...
                <div className="bg-gradient-to-br from-[#1e293b] to-[#0f172a] rounded-[2.5rem] border border-slate-700 p-8 relative overflow-hidden group hover:border-blue-500/50 transition-colors flex flex-col">
                    ...
                    <div className="relative z-10 flex flex-col h-full justify-between">
                       <div>
                          ...
                          <h2 className="text-3xl font-black text-white uppercase italic tracking-tighter">Team 2 (0)</h2>
                ...
                <div className="bg-gradient-to-br from-[#1e293b] to-[#0f172a] rounded-[2.5rem] border border-slate-700 p-8 relative overflow-hidden group hover:border-emerald-500/50 transition-colors flex flex-col">
                    ...
                    <div className="relative z-10 flex flex-col h-full justify-between">
                       <div>
                          ...
                          <h2 className="text-3xl font-black text-white uppercase italic tracking-tighter">Team 2 (-0.25)</h2>
